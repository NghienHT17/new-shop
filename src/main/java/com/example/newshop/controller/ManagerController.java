...
import com.example.newshop.model.Category;
import com.example.newshop.model.Product;
import com.example.newshop.service.CategoryService;
import com.example.newshop.service.FileUploadService;
...
public class ManagerController {
    ...
    public ModelAndView addProduct(Product product, @RequestParam("file") MultipartFile file) {
        ModelAndView mv = new ModelAndView("manager/product-form");
        System.out.println("file: " + file.getOriginalFilename());//in ra console
